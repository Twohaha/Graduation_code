...
from graduation_code.utils.general import xywh2xyxy, xyxy2xywh
from graduation_code.utils.metrics import fitness
...
def plot_images(images, targets, paths=None, fname='txt_need.jpg', names=None, max_size=640, max_subplots=16, kpt_label=True, steps=2, orig_shape=None):
    ...
    bs = min(bs, max_subplots)  # limit plot txt_need
    ...
    for i, img in enumerate(images):
        if i == max_subplots:  # if last batch has fewer txt_need than we expect
            break
...
def plot_study_txt(path='', x=None):  # from utils.plots import *; plot_study_txt()
    # Plot study.txt generated by main_UI.py
