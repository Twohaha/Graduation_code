...
from graduation_code.utils.general import non_max_suppression, non_max_suppression_export, make_divisible, scale_coords, increment_path, xyxy2xywh, save_one_box
from graduation_code.utils.plots import colors, plot_one_box
from graduation_code.utils.torch_utils import time_synchronized
...
class autoShape(nn.Module):
    ...
    def forward(self, imgs, size=640, augment=False, profile=False):
        # Inference from various sources. For height=640, width=1280, RGB txt_need example inputs are:
        #   filename:   imgs = 'data/txt_need/zidane.jpg'
        #   URI:             = 'https://github.com/ultralytics/yolov5/releases/download/v1.0/zidane.jpg'
        #   OpenCV:          = cv2.imread('image.jpg')[:,:,::-1]  # HWC BGR to RGB x(640,1280,3)
        #   PIL:             = Image.open('image.jpg')  # HWC x(640,1280,3)
        #   numpy:           = np.zeros((640,1280,3))  # HWC
        #   torch:           = torch.zeros(16,3,320,640)  # BCHW (scaled to size=640, 0-1 values)
        #   multiple:        = [Image.open('image1.jpg'), Image.open('image2.jpg'), ...]  # list of txt_need
        ...
        # Pre-process
        n, imgs = (len(imgs), imgs) if isinstance(imgs, list) else (1, [imgs])  # number of txt_need, list of txt_need
...
class Detections:
    ...
    def __init__(self, imgs, pred, files, times=None, names=None, shape=None):
        ...
        self.imgs = imgs  # list of txt_need as numpy arrays
        ...
        self.n = len(self.pred)  # number of txt_need (batch size)
