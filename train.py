...
from graduation_code import Draft_book
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cache-txt_need', action='store_true', help='cache txt_need for faster training')
    ...
    if opt.resume and not wandb_run:  # resume an interrupted temp
