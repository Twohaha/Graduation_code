from graduation_code.plate_recognition.plateNet import myNet_ocr,myNet_ocr_color
import torch
...
if __name__ == '__main__':
   ...
   image_path ="txt_need/tmp2424.png"
   testPath = r"/mnt/Gpan/Mydata/pytorchPorject/CRNN/crnn_plate_recognition/txt_need"
   fileList=[]
